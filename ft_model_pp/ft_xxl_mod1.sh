...
# sbatch --priority=0 --job-name=fts1 --mem=0 --exclusive ft_xxl_mod1.sh
# sbatch -x idc-beta-batch-pvc-node-[03,09,20,21] --priority=0 --job-name=fts1 --mem=0 --exclusive ft_xxl_mod1.sh
# sbatch -x idc-beta-batch-pvc-node-[03,09,20,21] --priority 0 --job-name fts2 --dependency=afterany:30747 --mem=0 --exclusive ft_xxl_mod1.sh
...
export checkpoint_dir="/home/u131168/mh_shell/ft_models/flan-t5-xxl_mt5_v1/"
